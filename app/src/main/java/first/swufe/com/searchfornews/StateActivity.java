...
public class StateActivity extends ListActivity implements Runnable,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                if(msg.what==7){
                    ...
                    ListAdapter adapter = new ArrayAdapter<String>(StateActivity.this,android.R.layout.simple_list_item_1,list2);
                    setListAdapter(adapter);
                }
    ...
    public void run() {
        ...
        Document doc = null;
        try {
            doc = Jsoup.connect("https://www.swufe.edu.cn/1459.html").get();
