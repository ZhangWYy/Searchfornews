...
public class CourseActivity extends ListActivity implements Runnable,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter<String>(CourseActivity.this,android.R.layout.simple_list_item_1,list2);
        setListAdapter(adapter);
        }
...
@Override
    public void run() {
        ...
        Document doc = null;
        try {
        doc = Jsoup.connect("https://www.swufe.edu.cn/1458.html").get();
